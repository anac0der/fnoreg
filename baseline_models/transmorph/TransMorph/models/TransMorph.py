...
import numpy as np
from . import configs_TransMorph
...
CONFIGS = {
    'TransMorph': configs_TransMorph.get_3DTransMorph_config(),
    'TransMorph-No-Conv-Skip': configs_TransMorph.get_3DTransMorphNoConvSkip_config(),
    'TransMorph-No-Trans-Skip': configs_TransMorph.get_3DTransMorphNoTransSkip_config(),
    'TransMorph-No-Skip': configs_TransMorph.get_3DTransMorphNoSkip_config(),
    'TransMorph-Lrn': configs_TransMorph.get_3DTransMorphLrn_config(),
    'TransMorph-Sin': configs_TransMorph.get_3DTransMorphSin_config(),
    'TransMorph-No-RelPosEmbed': configs_TransMorph.get_3DTransMorphNoRelativePosEmbd_config(),
    'TransMorph-Large': configs_TransMorph.get_3DTransMorphLarge_config(),
    'TransMorph-Small': configs_TransMorph.get_3DTransMorphSmall_config(),
    'TransMorph-Tiny': configs_TransMorph.get_3DTransMorphTiny_config(),
}
