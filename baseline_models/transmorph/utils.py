...
def jacobian_determinant(disp):
    ...
    Parameters:
        disp: 2D isplacement field of size [*vol_shape, 2],
              where vol_shape is of len 2
    Returns:
...
def jacobian_determinant_3d(disp):
    ...
    NB: to compute the spatial gradients, we use np.gradient.
    Parameters:
        disp: 2D or 3D displacement field of size [*vol_shape, 3],
              where vol_shape is of len 3
    Returns:
        jacobian determinant (scalar)
    """
